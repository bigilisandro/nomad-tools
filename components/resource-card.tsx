          ...
          <div className="flex justify-between items-start mb-4">
            ...
            >
              {logoPreview ? (
                ...
                <Image
                  src={imageUrl || `/placeholder.svg?height=48&width=48&text=${name.charAt(0)}`}
                  alt={`${name} logo`}
                  width={48}
                  height={48}
                  className="object-contain"
                ...
                <div className="text-white text-xl font-bold">{name ? name.charAt(0) : "?"}</div>
              )}
            </div>
            <div className="flex items-center gap-2">
              ...
              {featured && <Star className="h-5 w-5 text-primary fill-primary" />}
            </div>
          </div>
